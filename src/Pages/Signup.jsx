...
import { signInWithGoogle, signInWithGithub, signUp, getCurrentUser } from "../features/auth/auth"
...
function Signup() {
    ...
    return (
        <main id="signup" className={' w-full  h-screen inset-0 bg-[rgba(27,27,27,0.6)] z-50'}>
            <div className="w-full h-full flex justify-center items-center">
                ...
                <div className="w-full h-full max-w-[800px] md:max-h-[550px] sm:h-auto flex flex-col sm:flex-row shadow-[0_4px_30px_rgba(0,0,0,0.1)] sm:rounded-[8px] ">
                    ...
                    <div className={' relative w-full md:w-1/2 h-full md:h-auto flex flex-col justify-stretch  md:justify-between  bg-[#FFFFFF] p-5 sm:rounded-tr-[8px] sm:rounded-br-[6px]'}>
                        ...
                        <X size={20} className="cursor-pointer absolute top-2 right-2" onClick={() => { navigate(-1) }} />
                        ...
                        <form className={'flex flex-col gap-2'} onSubmit={formik.handleSubmit}>
                            ...
                            <input type="submit" value="Create Account" name="submit"
                                className={' bg-[#3DCBB1] hover:bg-[#19a88e] w-full text-white font-semibold py-[10px] px-[18px] rounded-[14px] items-center border"'} />
                        </form>

                        <div className={'text-center mt-[50px] md:mt-1'}>
                            Already have an account? <span onClick={() => { navigate('/login'); }} className={'text-[#3DCBB1] hover:underline cursor-pointer'}>Log In</span>
                        </div>
                    </div>
                </div>
            </div>
