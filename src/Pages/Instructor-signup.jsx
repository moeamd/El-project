...
try {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-gray-100 dark:bg-surface-dark pt-10">
      {" "}
      <div className="bg-white dark:bg-card max-w-lg p-6 rounded-xl shadow-lg center w-[400px] transition-colors duration-300">
        <button
          onClick={onClose}
        ...
        <div className="text-center mt-5">
          <p>
            ...
            <Link to="/login" className="text-[#3DCBB1] text-bold">
              Login
            </Link>
          </p>
        </div>
