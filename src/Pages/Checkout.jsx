...
export default function Checkout() {
    return <div className="flex-1 flex flex-col items-center p-12">
        <div className="w-full max-w-5xl bg-white rounded-lg shadow-md p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Form Section */}
